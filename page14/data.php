...
// $review3 = new Review($coffee->getName(), $user2->getName(), 'Wanginya harum');
// $review4 = new Review($pasta->getName(), $user2->getName(), 'Sausnya enak :)');
// $review5 = new Review($juice->getName(), $user3->getName(), 'Hanya jus jeruk biasa');
// $review6 = new Review($curry->getName(), $user3->getName(), 'Rasanya enak untuk harganya');
// $review7 = new Review($coffee->getName(), $user4->getName(), 'Kepahitannya cukup.');
// $review8 = new Review($pasta->getName(), $user4->getName(), 'Banhan yang digunakan berkualitas.');
